...
class QrCameraC2 implements QrCamera {
    ...
    @Override
    public void start(final QrReader qrReader) throws QrReader.Exception {
    ...
    //ref: https://stackoverflow.com/questions/52158395/how-to-zoom-camera-using-android-camera2-api
    public float getMaxZoom() {
        try {
            if (cameraDevice == null) return -1;
            return (cameraCharacteristics.get(CameraCharacteristics.SCALER_AVAILABLE_MAX_DIGITAL_ZOOM)) * 10;
        } catch (Exception e) {
